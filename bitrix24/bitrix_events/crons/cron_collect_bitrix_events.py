...
def cron_collect_bitrix_events(token_id: int, event_class: Union[Type[BitrixEvent], str]) -> str:
    """Собирает одну страницу офлайн-событий.

    token_id: ID администраторского токена из bitrix24.models.BitrixUserToken
    ...
    token = BitrixUserToken.objects.get(pk=token_id)
